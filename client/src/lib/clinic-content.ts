...
export const services = [
  {
    ...
    short: "A calm starting point for regular check-ins and everyday questions.",
  ...
  },
  {
    ...
    short: "Clear, clinic-approved prevention conversations tailored to the pet in front of you.",
  ...
  },
  {
    ...
    short: "Practical guidance for a pet’s early months and first clinic conversations.",
  ...
  },
  {
    ...
    short: "An approachable introduction to your clinic’s approved oral-care options.",
  ...
  },
  {
    ...
    short: "An information-first route for more detailed care conversations.",
...
export const faqs = [
  {
    question: "Is Paws & Pine a real clinic?",
    answer: "No. Paws & Pine is fictional sample content created to demonstrate a Tier 1 veterinary website. Names, contact details, hours, services, and imagery are presentation material only.",
  },
  {
    question: "What happens when I send this request?",
    answer: "In a real Tier 1 site, an approved form can record a request in a provider-managed Google Sheet for clinic follow-up. This demo form only shows a local confirmation and does not send data or create an appointment.",
  },
  {
    question: "Can a real clinic use this layout?",
    answer: "Yes. A production version should replace every fictional detail with approved clinic information, verified contacts, authorized imagery, and the agreed request-workflow configuration.",
  },
  {
    question: "Does this site offer medical advice?",
    answer: "No. This demo explains a website structure, not veterinary advice, availability, pricing, or treatment recommendations.",
  },
] as const;

export const assets = {
  hero: "/manus-storage/paws-pine-hero_7806da61.jpg",
  catCare: "/manus-storage/paws-pine-cat-care_7c4ca6cf.jpg",
  dogCare: "/manus-storage/paws-pine-dog-care_a22a2df2.jpg",
  clinicDetail: "/manus-storage/paws-pine-clinic-detail_d842b33b.jpg",
