/**
 * Public homepage for Hayop Kalinga Veterinary Clinic.
 */
...
export default function Home() {
  return <main className="neo-main fidelity-home">
    <PageMeta title="Hayop Kalinga Veterinary Clinic" description="Thoughtful veterinary care conversations, clear service pathways, and a simple visit request process." />
    <section className="fidelity-hero pp-major-light-stage">
      <div className="fidelity-blue-field" aria-hidden="true" />
      <div className="fidelity-title-stack"><span className="fidelity-kicker"><PawPrint size={15} /> Hayop Kalinga Veterinary Clinic</span><div className="fidelity-title-mask"><h1>Hayop Kalinga</h1></div></div>
      <img className="fidelity-pets" src={assets.heroPets} width="2560" height="1440" fetchPriority="high" alt="Hayop Kalinga clinic dog and cat" />
    ...
    <section className="fidelity-about"><div className="fidelity-about-visual"><img src={assets.aboutPup} alt="A small dog in a lime green sweater" /></div><div className="fidelity-about-copy"><span className="fidelity-kicker">About Hayop Kalinga</span><h2>Gentle care begins with <em>clear conversations.</em></h2><p>From routine visits to moments that need a closer look, Hayop Kalinga gives pet parents an easier way to understand their options and choose a next step.</p><div className="fidelity-metrics"><div><strong>06</strong><span>care pathways</span></div><div><strong>01</strong><span>clear starting point</span></div><div><strong>03</strong><span>thoughtful steps</span></div></div></div></section>
    ...
    <section className="fidelity-cta"><div><span className="fidelity-kicker fidelity-kicker-light">Hayop Kalinga Veterinary Clinic</span><h2>A better beginning<br />starts <em>here.</em></h2></div><div><p>Send a few useful details, then let the right next step take shape from there.</p><Link href="/request" className="lime-cta">Request a visit <ArrowUpRight size={17} /></Link></div></section>
  </main>;
}
