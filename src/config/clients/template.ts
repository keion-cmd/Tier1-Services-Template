...
function serviceProcess(steps: [string, string][]) {
...
/**
 * The generic placeholder-token template — this repo's shipped default. Every field is a
 * `[BRACKET_TOKEN]` meant to be replaced per `CLIENT_CONFIG_TEMPLATE.md` when cloning for a
 * real client. Keep `siteSettings.isTemplateDemo: true` here only — every real client config
 * must set it to `false` (see `Footer.tsx`'s `<TemplateSelfPromo />` gate).
 */
export const template: ClientConfig = {
  business: {
    name: "[BUSINESS_NAME]",
    ...
    // Clearly labelled platform-homepage placeholders. Replace with client-approved
    // business-profile URLs before launch.
    socialLinks: [
  ...
  seo: {
    siteOrigin: "https://tier1-services-template.vercel.app",
  },
  ...
  copy: {
    ...
    successStories: {
      heroEyebrow: "[SUCCESS_STORIES_HERO_EYEBROW]",
      heroTitle: "[SUCCESS_STORIES_HERO_TITLE]",
      heroSubtitle: "[SUCCESS_STORIES_HERO_SUBTITLE]",
      gridEyebrow: "Client stories",
      gridTitle: "Real outcomes, real care",
      ctaTitle: "[SUCCESS_STORIES_CTA_TITLE]",
    },
    contact: {
      heroEyebrow: "[CONTACT_HERO_EYEBROW]",
      heroTitle: "[CONTACT_HERO_TITLE]",
      heroSubtitle: "[CONTACT_HERO_SUBTITLE]",
  ...
  providers: [
    ...
    },
    {
      ...
      relatedServiceSlugs: ["service-3", "service-4"],
      placeholder: true,
    },
    {
      slug: "provider-3",
      ...
      relatedServiceSlugs: ["service-5", "service-6"],
      placeholder: true,
    },
    {
      slug: "provider-4",
      ...
      relatedServiceSlugs: ["service-7", "service-8"],
      placeholder: true,
    },
  ],
  ...
  locations: [
    {
      ...
      serviceSlugs: ["service-1", "service-2", "service-3"],
      ...
      accessNotes: "[LOCATION_1_ACCESS_NOTES]",
    },
    {
      slug: "location-2",
      ...
      serviceSlugs: ["service-4", "service-5", "service-6"],
      ...
      accessNotes: "[LOCATION_2_ACCESS_NOTES]",
    },
  ],

  testimonials: [
    { author: "[REVIEW_1_AUTHOR]", segment: "[REVIEW_1_SEGMENT]", quote: "[REVIEW_1_QUOTE]", rating: 5, serviceSlug: "service-1" },
    { author: "[REVIEW_2_AUTHOR]", segment: "[REVIEW_2_SEGMENT]", quote: "[REVIEW_2_QUOTE]", rating: 5, serviceSlug: "service-2" },
    { author: "[REVIEW_3_AUTHOR]", segment: "[REVIEW_3_SEGMENT]", quote: "[REVIEW_3_QUOTE]", rating: 5, serviceSlug: "service-3" },
    { author: "[REVIEW_4_AUTHOR]", segment: "[REVIEW_4_SEGMENT]", quote: "[REVIEW_4_QUOTE]", rating: 5, serviceSlug: "service-4" },
    { author: "[REVIEW_5_AUTHOR]", segment: "[REVIEW_5_SEGMENT]", quote: "[REVIEW_5_QUOTE]", rating: 5, serviceSlug: "service-5" },
  ],
  ...
  resources: [
    ...
    },
    {
      ...
      disclaimer: true,
      relatedServiceSlugs: ["service-7"],
    },
  ],

  faqs: [
    { question: "[FAQ_1_QUESTION]", answer: "[FAQ_1_ANSWER]", category: "Requests & visits", serviceSlug: "service-1" },
    { question: "[FAQ_2_QUESTION]", answer: "[FAQ_2_ANSWER]", category: "Emergency" },
    { question: "[FAQ_3_QUESTION]", answer: "[FAQ_3_ANSWER]", category: "Requests & visits" },
    { question: "[FAQ_4_QUESTION]", answer: "[FAQ_4_ANSWER]", category: "Requests & visits" },
    { question: "[FAQ_5_QUESTION]", answer: "[FAQ_5_ANSWER]", category: "Requests & visits" },
    { question: "[FAQ_6_QUESTION]", answer: "[FAQ_6_ANSWER]", category: "Requests & visits" },
    { question: "[FAQ_7_QUESTION]", answer: "[FAQ_7_ANSWER]", category: "Payment & insurance" },
    { question: "[FAQ_8_QUESTION]", answer: "[FAQ_8_ANSWER]", category: "First visit", serviceSlug: "service-1" },
  ],
  ...
  content: {
    ...
    carePlans: [
      { title: "[CARE_PLAN_1_TITLE]", subtitle: "[CARE_PLAN_1_SUBTITLE]", bullets: ["[CARE_PLAN_1_BULLET_1]", "[CARE_PLAN_1_BULLET_2]", "[CARE_PLAN_1_BULLET_3]"] },
      { title: "[CARE_PLAN_2_TITLE]", subtitle: "[CARE_PLAN_2_SUBTITLE]", bullets: ["[CARE_PLAN_2_BULLET_1]", "[CARE_PLAN_2_BULLET_2]", "[CARE_PLAN_2_BULLET_3]", "[CARE_PLAN_2_BULLET_4]"] },
      { title: "[CARE_PLAN_3_TITLE]", subtitle: "[CARE_PLAN_3_SUBTITLE]", bullets: ["[CARE_PLAN_3_BULLET_1]", "[CARE_PLAN_3_BULLET_2]", "[CARE_PLAN_3_BULLET_3]", "[CARE_PLAN_3_BULLET_4]"] },
    ],
    serviceChoiceSteps: [
    ...
    proofCareStats: [
      { value: "[PROOF_STAT_1_VALUE]", label: "[PROOF_STAT_1_LABEL]", description: "[PROOF_STAT_1_DESCRIPTION]" },
      { value: "[PROOF_STAT_2_VALUE]", label: "[PROOF_STAT_2_LABEL]", description: "[PROOF_STAT_2_DESCRIPTION]" },
      { value: "[PROOF_STAT_3_VALUE]", label: "[PROOF_STAT_3_LABEL]", description: "[PROOF_STAT_3_DESCRIPTION]" },
    ],
    proofPageStories: [
    ...
    locationsAdjacentMarqueeId: "insurance",
  },
};
