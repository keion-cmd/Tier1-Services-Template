...
export const copy = {
  ...
  siteShell: {
    ...
    policyDetailsLinkLabel: "[SITE_SHELL_POLICY_DETAILS_LINK_LABEL]",
    policyDetailsBadge: "[SITE_SHELL_POLICY_DETAILS_BADGE]",
    policyDetailsTitle: "[SITE_SHELL_POLICY_DETAILS_TITLE]",
    policyDetailsDescription: "[SITE_SHELL_POLICY_DETAILS_DESCRIPTION]",
