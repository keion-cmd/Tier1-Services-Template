...
## Approved Clinic Identity Correction

- [x] Replace Paws+Pine clinic identity references with Hayop Kalinga Veterinary Clinic across the client-visible site shell, metadata, request experience, and Location Page.
- [x] Use the approved address: Center Stall No. 4027, 2nd Street, Calamba, Laguna, consistently in location, map, directions, and footer content.
- [x] Preserve clearly identified placeholders where no approved phone, email, social URL, logo, or policy information has been supplied.
- [x] Validate client-visible name/address consistency, Google Maps directions, request messaging, and responsive UI before checkpointing.
